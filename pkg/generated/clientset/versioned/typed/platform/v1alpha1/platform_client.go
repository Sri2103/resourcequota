...
import (
	...
	"github.com/sri2103/resource-quota-enforcer/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type PlatformV1alpha1Interface interface {
	RESTClient() rest.Interface
	ResourceQuotaPoliciesGetter
}

// PlatformV1alpha1Client is used to interact with features provided by the platform.example.com group.
type PlatformV1alpha1Client struct {
	restClient rest.Interface
}

func (c *PlatformV1alpha1Client) ResourceQuotaPolicies(namespace string) ResourceQuotaPolicyInterface {
	return newResourceQuotaPolicies(c, namespace)
}
